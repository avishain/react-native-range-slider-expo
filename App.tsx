        ...
        <View style={[styles.container, { padding: styleSize === 'large' ? 7 : styleSize === 'medium' ? 14 : 21 }]}>
            {
                ...
                <View style={{ width: '100%' }}>
                    ...
                    >
                        ...
                        <TextInput style={{ position: 'absolute', width: 40, textAlign: 'center', left: (knobSize - 40) / 2, color: valueLabelsTextColor, bottom: 25, fontWeight: 'bold' }} ref={fromValueTextRef} />
                    </Animated.View>
                    <Animated.View
                    ...
                    >
                        ...
                        <TextInput style={{ position: 'absolute', width: 40, textAlign: 'center', left: (knobSize - 40) / 2, color: valueLabelsTextColor, bottom: 25, fontWeight: 'bold' }} ref={toValueTextRef} />
                    </Animated.View>
                </View>
            }
